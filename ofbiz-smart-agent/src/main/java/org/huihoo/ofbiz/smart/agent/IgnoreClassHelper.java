...
public class IgnoreClassHelper {
  ...
  public boolean isIgnoreClass(String className) {
    ...
    // the rest of OFBiz Smart should be ignored
    if (className.startsWith("org/huihoo/ofbiz/smart/")) {
      return true;
    }
    ...
    if (className.startsWith("ch/qos/")) {
      return true;
    }
    // igore ojbectweb
    if (className.startsWith("org/objectweb/")) {
      return true;
    }
    ...
    if (className.startsWith("com/mchange/")) {
      return true;
    }
